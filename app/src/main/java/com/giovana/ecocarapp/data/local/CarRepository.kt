package com.giovana.ecocarapp.data.local

import android.content.ContentValues
import android.content.Context
import android.provider.BaseColumns
import android.util.Log
import com.giovana.ecocarapp.data.local.CarrosContract.CarEntry.COLUMN_NAME_BATERIA
import com.giovana.ecocarapp.data.local.CarrosContract.CarEntry.COLUMN_NAME_CAR_ID
import com.giovana.ecocarapp.data.local.CarrosContract.CarEntry.COLUMN_NAME_POTENCIA
import com.giovana.ecocarapp.data.local.CarrosContract.CarEntry.COLUMN_NAME_PRECO
import com.giovana.ecocarapp.data.local.CarrosContract.CarEntry.COLUMN_NAME_RECARGA
import com.giovana.ecocarapp.data.local.CarrosContract.CarEntry.COLUMN_NAME_URL_PHOTO
